...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private void btnTesKoneksi_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Koneksi ke database gagal!", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try
            {
                string dbName = @"D:\PEMROG LANJUT\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Data mahasiswa gagal disimpan!!!", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void btnCariUpdate_Click(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Data mahasiswa tidak ditemukan!", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@npm", txtNpmUpdate);
